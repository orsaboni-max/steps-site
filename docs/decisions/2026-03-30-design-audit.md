# אודיט עיצוב — 30/3/2026 (מצב האתר **לפני** הרידיזיין של 1/8/2026)

> ⚠️ מסמך היסטורי. הוא מתאר את דף הבית הישן: Heebo יחיד, מבטא `#F5C518`, טורקיז `#2EC4B6`, AOS.
> **כל זה כבר לא נכון.** הערכה הנוכחית (ink/bone/`#FFD400`, Heebo+Assistant) מתועדת ב-CLAUDE.md תחת "Design Tokens".
> נשמר כדי להבין החלטות עבר; לא לעבוד לפיו. הועבר מ-CLAUDE.md ב-7/9/2026.
