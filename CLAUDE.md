...
- סדר סשנים: R0 (קציר ביקורות — בוצע 7/9) → S1 דפי שירות → S2 מדריכים+ילדים → **S3 בית+תזונה+קבצי מערכת — בוצע 7/9/2026** → RV1 ביקורת+דיפלוי #1 → S4 תוכן → S5 ויזואל Higgsfield → RV2 → מדידה יום 30/60/90.
